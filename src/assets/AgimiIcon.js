...
const AgimiIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <g stroke="#fff" strokeMiterlimit={10} strokeWidth={1.2} clipPath="url(#a)">
      <path d="M42.743 26.384h-31.89c0-8.174 7.133-14.819 15.93-14.819 8.796 0 15.93 6.645 15.93 14.819h.03Z" />
      <path
        strokeLinecap="round"
